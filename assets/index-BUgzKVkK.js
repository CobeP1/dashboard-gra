(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`/dashboard-gra/assets/logo-gra-TlnCa9h_.png`,t=`https://script.google.com/macros/s/AKfycby2aHIs5BK7ZmQdu5Dh36AOQDaJ3hJSpkJeJAf9SwtPcHy1OSE3LeeDad1u-_wuD1kLkQ/exec`,n=`https://manualgra.gitbook.io/manual-de-conduta-g.r.a`,r=[`Comando`,`Sub.Comando`,`Operador Sentinel`,`Operador Raven`,`Operador Hawk`,`Operador Classe I`,`Operador Classe II`,`Operador Classe III`,`Aspirante a Operador`];document.querySelector(`#app`).innerHTML=`
  <div class="app-shell">
    <header class="hero">
